...
" Normal mode
let s:N1 = [s:gui_dark_gray, s:gui_blue, s:cterm_dark_gray, s:cterm_green]
...
" Insert mode
let s:I1 = [s:gui_med_gray_hi, s:gui_green, s:cterm_med_gray_hi, s:cterm_blue]
