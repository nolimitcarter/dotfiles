...
let g:colors_name = 'javacafe'
" }}}
" Configuration: {{{
let s:configuration = {}
let s:configuration.palette = get(g:, 'javacafe_palette', 'soft')
let s:configuration.transparent_background = get(g:, 'javacafe_transparent_background', 0)
let s:configuration.disable_italic_comment = get(g:, 'javacafe_disable_italic_comment', 0)
let s:configuration.enable_italic = get(g:, 'javacafe_enable_italic', 0)
let s:configuration.cursor = get(g:, 'javacafe_cursor', 'auto')
let s:configuration.current_word = get(g:, 'javacafe_current_word', get(g:, 'javacafe_transparent_background', 0) == 0 ? 'grey background' : 'bold')
" }}}
" Palette: {{{
let s:palette = {
      \ 'bg0':        ['#30333d',   '235',  'Black'],
      \ 'bg1':        ['#424757',   '236',  'DarkGrey'],
      \ 'bg2':        ['#424757',   '237',  'DarkGrey'],
      \ 'bg3':        ['#30333d',   '238',  'DarkGrey'],
      \ 'bg4':        ['#30333d',   '239',  'Grey'],
      \ 'bg_red':     ['#424757',   '52',   'DarkRed'],
      \ 'bg_green':   ['#737B99',   '22',   'DarkGreen'],
      \ 'bg_blue':    ['#575D74',   '17',   'DarkBlue'],
      \ 'fg':         ['#f0f0f0',   '223',  'White'],
      \ 'red':        ['#fca3ab',   '167',  'Red'],
      \ 'orange':     ['#FCC5A3',   '208',  'Red'],
      \ 'yellow':     ['#fbebbb',   '214',  'Yellow'],
      \ 'green':      ['#a6d5b1',   '108',  'Green'],
      \ 'cyan':       ['#c8e6d7',   '108',  'Cyan'],
      \ 'blue':       ['#bccaf0',   '109',  'Blue'],
      \ 'purple':     ['#d8c2ee',   '175',  'Magenta'],
      \ 'grey':       ['#737B99',   '245',  'LightGrey'],
      \ 'light_grey': ['#737B99',   '245',  'LightGrey'],
      \ 'gold':       ['#A4BAF0',   '214',  'Yellow'],
      \ 'none':       ['NONE',      'NONE', 'NONE']
      \ }
" }}}
" Function: {{{
